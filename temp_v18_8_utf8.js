...
const GlobalLibrary = {
    spiritual: {
        ...
        intro: "In this sanctuary, we dissolve the static of your history. Your Spiritual Identity is the foundationΓÇöthe primal connection that determines the shape of every outcome. We are here to listen for the subtle signals of your expansion.",
        ...
        states_of_power: ["Savant Insight", "Effortless Wisdom", "Spiritual Autonomy", "The Flow of Oneness", "Resonant Stillness", "Infinite Patience", "Joyful Expansion", "The SoulΓÇÖs Sanctuary", "Transcendent Focus", "The Witness State", "Archetypal Presence", "Vibrant Oneness", "Metaphysical Ease", "Timeless Being", "Absolute Spirit"]
    },
    mental: {
        ...
        states_of_power: ["Absolute Certainty", "Strategic Mastery", "Cognitive Flow", "Genius Unbound", "Sharp Intuition", "The ArchitectΓÇÖs Mind", "Analytic Speed", "Creative Synthesis", "Mastery of Concept", "Unshakeable Concentration", "High-Frequency Logic", "Savant Memory", "Effortless Learning", "The Observer Mind", "Universal Intelligence"]
    },
    vocational: {
...
const AlchemicalDeclarations = {
    ...
    'mental': {
        ...
        'The ArchitectΓÇÖs Mind': "I build my reality with the logic of universal intelligence.",
    ...
    'physical': {
        'Prime Vitality': "My body is a high-resolution vessel for my soulΓÇÖs expansion.",
...
function synthesizeNarrative(p) {
    ...
    if (specificVision) {
        ...
        if (specificVision.includes('vitality') || specificVision.includes('strength')) {
            script += `My body is a high-resolution vessel for my soulΓÇÖs expansion. I move with kinetic ease and absolute focus, fueled by an infinite well of stamina.\n\n`;
        }
        // Familial
    ...
    if (selected.length > 0) {
        ...
        selected.forEach(gem => { script += `ΓÇó ${lib[gem]}\n`; });
        script += `\n`;
    }
